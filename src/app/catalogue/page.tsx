...
import { services, getArticlesByService, getFeaturedByService } from "@/data/mock";
    ...
    <div className="min-h-screen bg-charcoal-deep pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        {services.map((service, si) => {
          const featured = getFeaturedByService(service.key, 4);
          const allCount = getArticlesByService(service.key).length;
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{service.tagline_fr} — {allCount} articles</p>
                  </div>
                </div>
                <Link
                  href={service.href}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {featured.map((article, i) => (
                  ...
                  >
                    ...
                    <div className="p-3">
                      <Link href={`/article/${article.slug}`}>
                        <h3 className={`text-xs font-semibold line-clamp-2 mb-1 hover:${style.accent} transition-colors text-off-white`}>
                          {article.name_fr}
                        </h3>
                      </Link>
